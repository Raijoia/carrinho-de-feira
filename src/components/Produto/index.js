      ...
      <Container>
        ...
        <div>
          <IconButton
            ...
            // desabilita botão quando não estiver no carrinho
            disabled={!produtoNoCarrinho}
          >
            <RemoveIcon />
          </IconButton>
          {/* ? => se tiver, se não tiver nada no carrinho, não faz nada, evitando que o código quebre quando não tiver nada no carrinho */}
